        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Halaman Utama Aplikasi Tingkat Kematangan Keselarasan Organisasi</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row" >
                <div class="col-lg-12" >
                    <div class="panel panel-default" id="responden">
                        <div class="panel-heading">
                    ...
                    <!-- /.panel -->
                    <div class="panel panel-default" id="jabatan">
                        <div class="panel-heading">
